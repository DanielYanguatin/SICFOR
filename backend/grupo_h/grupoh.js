...
async function loadEvaluaciones() {
    try {
        ...
        evaluaciones.forEach(evaluacion => {
            ...
            // Si la fecha límite ya pasó y aún está pendiente
            if (diasRestantes < 0 && estadoText === 'Pendiente') {
                estadoText = 'Vencida';
                estadoClass = 'status-vencida';
            } else if (estadoText === 'Finalizado') {
                estadoClass = 'status-finalizado';
            } else if (estadoText === 'Activo') {
                estadoClass = 'status-activo';
            } else if (estadoText === 'Pendiente') {
            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    ${diasRestantes >= 0 ? 
                        `<span class="dias-restantes">(${diasRestantes} días)</span>` : 
                        `<span class="dias-vencido">(Vencida)</span>`
                    }
                </td>
